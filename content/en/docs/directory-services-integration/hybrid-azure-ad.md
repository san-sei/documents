...
*Replace admin@idmelon.com in the following example with your on-premises Active Directory domain name.*
...
**Warning:** *If your password has expired, signing in with FIDO is blocked. The expectation is that users reset their passwords before they can log in by using FIDO.*
