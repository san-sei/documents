...
1. To activate your security key, go ahead and tap on **Personal** in this page and in the next page enter your email
   ...
   <img src="/images/vendor/MobileApp/mobileapp_1.jpg" class="doc-img-frame">
...
2. In this page, enter your email address, username, password, and click on **Send verification email**. After that, you
   ...
   <img src="/images/vendor/MobileApp/mobile_app_2_1.jpg" class="doc-img-frame">
...
3. In this page, you can open your email app by tapping on **Open email app** and then click on the activation link in
   ...
   <img src="/images/vendor/MobileApp/mobile_app_3.png" class="doc-img-frame">
...
5. If you clicked on **Verify with code**, you will be moved to a page which requires you to enter a six-digit number to
   ...
   <img src="/images/vendor/MobileApp/mobile_app_4.png" class="doc-img-frame">
...
6. In this page, as you can see, you have to type a name for your security key. Moreover, you can choose your license
   ...
   <img src="/images/vendor/MobileApp/mobile_app_2_2.jpg" class="doc-img-frame">

If you click on **License Type**, you will see a page which contains the following license types, choose the type
that you prefer.

   <img src="/images/vendor/MobileApp/mobile_app_licence_type.jpg" class="doc-img-frame">

If you clicked on **skin**, you will be moved to a page, which contains some skins for your security key.

   <img src="/images/vendor/MobileApp/mobile_app_security_skin.jpg" class="doc-img-frame">

7. Congratulations, you have successfully created your security key, click **Done**.

   <img src="/images/vendor/MobileApp/moblie_app_2_3.jpg" class="doc-img-frame">

8. Here you can see your security key and manage it.

<img src="/images/vendor/MobileApp/mobile_app_2_4.jpg" class="doc-img-frame">
...
5. In this page, tap on **Approve** to activate your security key on your smartphone.
   ...
   <img src="/images/vendor/MobileApp/mobile_app_confirmation.jpg" class="doc-img-frame">
...
<img src="/images/vendor/MobileApp/upgrade/1.jpg" width="55%" class="doc-img-frame">

<img src="/images/vendor/MobileApp/upgrade/2.jpg" width="55%" class="doc-img-frame">

<img src="/images/vendor/MobileApp/upgrade/3.jpg" width="55%" class="doc-img-frame">

<img src="/images/vendor/MobileApp/upgrade/4.jpg" width="55%" class="doc-img-frame">
