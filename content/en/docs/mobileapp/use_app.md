...
<div class="step-row-container">
  ...
  <div class="card-column">
    <div class="step-text" >
      <div class="card-body">
        <p>First, download and install IDmelon app from App Store or Google Play.</p>
      </div>
    </div>
  </div>
</div>
...
<div class="step-row-container">
  ...
  <div class="card-column">
    <div class="step-text" >
      <div class="card-body">
        <p>Then, go with one of the options below:</p>
      </div>
    </div>
  </div>
</div>
...
<div class="step-row-container">
  ...
  <div class="card-column">
    <div class="step-text" >
      <div class="card-body">
        <p>Plug an IDmelon Reader to a USB port of the PC and start experiencing Tap & Go!</p>
      </div>
    </div>
  </div>
</div>
...
<div class="step-row-container">
  ...
  <div class="card-column">
    <div class="step-text" >
      <div class="card-body">
        <p>To activate your security key, go ahead and tap on <span style="font-weight:bold;">Personal</span> in this page and in the next page enter your email address.</p>
      </div>
    </div>
  </div>
</div>
...
<div class="step-row-container">
  ...
  <div class="card-column">
    <div class="step-text" >
      <div class="card-body">
        <p>In this page enter your email addess, username, password and click on <span style="font-weight:bold;">Send verification email</span>, after that you will be moved to the next page.</p>
      </div>
    </div>
  </div>
</div>
...
<div class="step-row-container">
  ...
  <div class="card-column">
    <div class="step-text" >
      <div class="card-body">
        <p>In this page you can open your email app by tapping on<span style="font-weight:bold;">Open email app</span> and then click on the activation link in your email,or if  you do not have acces to your email on your device you can click on <span style="font-weight:bold;">Verify with code</span> in order to verify your email by entering a 6 digit code.</p>
      </div>
    </div>
  </div>
</div>
...
<div class="step-row-container">
  ...
  <div class="card-column">
    <div class="step-text" >
      <div class="card-body">
        <p>If you clicked on <span style="font-weight:bold;">Verify with code</span> you will be moved to a page which requires you to enter a six-digit number to verify your email address. After entering the code, click on <span style="font-weight:bold;">Done</span>.</p>
      </div>
    </div>
  </div>
</div>
...
<div class="step-row-container">
  ...
  <div class="card-column">
    <div class="step-text" >
      <div class="card-body">
        <p>In this page, as you can see, you have to type a name for your security key. Moreover, you can choose your licence type and also you can choose a skin for your security key. After finishing your configuration, click on <span style="font-weight:bold;">Next</span>.</p>
      </div>
    </div>
  </div>
</div>
...
<div class="step-row-container mx-4">
  <div class="step-column step-count-size">
    <p class="step-counter">1</p>
  </div>
  <div class="card-column">
    <div class="step-text" >
      <div class="card-body">
        <p>If you click on <span style="font-weight:bold;">Licence Type</span> you will see a page which contains the following licences types, choose the type that you prefer.</p>
      </div>
    </div>
  </div>
</div>
...
<div class="step-row-container mx-4">
  ...
  <div class="card-column">
    <div class="step-text" >
      <div class="card-body">
        <p>If you clicked on skin, you will be moved to a page, which contains some skins for your security key.</p>
      </div>
    </div>
  </div>
</div>
...
<div class="step-row-container">
  ...
  <div class="card-column">
    <div class="step-text" >
      <div class="card-body">
        <p>Congratulations, you have successfully created your securiyt key, click <span style="font-weight:bold;">Done</span>.</p>
      </div>
    </div>
  </div>
</div>
...
<div class="step-row-container">
  ...
  <div class="card-column">
    <div class="step-text" >
      <div class="card-body">
        <p>Here you can see your security key and manage it.</p>
      </div>
    </div>
  </div>
</div>
...
<div class="step-row-container">
  ...
  <div class="card-column">
    <div class="step-text" >
      <div class="card-body">
        <p>To activate your security key, go ahead and tap on <span style="font-weight:bold;">Business / School</span>.</p>
      </div>
    </div>
  </div>
</div>
...
<div class="step-row-container">
  ...
  <div class="card-column">
    <div class="step-text" >
      <div class="card-body">
        <p>In this page, you can access your email by tapping <span style="font-weight:bold;">Open email app</span> to see the verification code.</p>
      </div>
    </div>
  </div>
</div>
<p class="note-body"><span style="font-weight:bold;">Note</span>: The email that you receive must contain the same contents as the image below.</p>
<p align="center">
...
<div class="step-row-container">
  ...
  <div class="card-column">
    <div class="step-text" >
      <div class="card-body">
        <p>Enter the 6-digit code that you have received and then, tap on <span style="font-weight:bold;">Done</span>.</p>
      </div>
    </div>
  </div>
</div>
...
<div class="step-row-container">
  ...
  <div class="card-column">
    <div class="step-text" >
      <div class="card-body">
        <p>In this page, tap on <span style="font-weight:bold;">Approve</span> in order to activate your security key on your smartphone.</p>
      </div>
    </div>
  </div>
</div>
...
<div id="carouselExampleDark" class="carousel slide" data-bs-ride="carousel">
  ...
  <button class="carousel-control-prev" type="button" data-bs-target="#carouselExampleDark" data-bs-slide="prev">
    <svg fill="none" class="simple-stepper-svg" height="30px" width="30px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512" xml:space="preserve">
...
<div class="step-row-container">
  ...
  <div class="card-column">
    <div class="step-text" >
      <div class="card-body">
        <p>Open IDmelon app on your smartphone, go to the setting and click on the Pair with a New PC.</p>
      </div>
    </div>
  </div>
</div>
...
<div class="step-row-container">
  ...
  <div class="card-column">
    <div class="step-text" >
      <div class="card-body">
        <p>Point your phone camera at the QR code on your computer screen.</p>
      </div>
    </div>
  </div>
</div>
