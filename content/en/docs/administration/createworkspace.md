...
<div align="center">
    <img src="/images/vendor/Panel/workspace/1.png" class="doc-img-frame" style="width:60%;">
</div>
...
<div class="step-row-container">
  ...
  <div class="card-column">
    <div class="step-text" >
      <div class="card-body">
        <p> Choose <span style="font-weight:bold">Work or School</span> on behalf of your organization.
        </p>
      </div>
    </div>
  </div>
...
<div class="step-row-container">
  ...
  <div class="card-column">
    <div class="step-text" >
      <div class="card-body">
        <p style= "margin-bottom: 0">Fill in all the fields with your information including your email address and phone number.</p>
      </div>
    </div>
  </div>
</div>
...
<p class="note-body">
<span style="font-weight:bold;">Note</span> that you need to enter your business email to represent your organization, you cannot use an email at a free domain.</p>
...
<div align="center" style= "margin-top: 0">
    <img src="/images/vendor/Panel/workspace/9-1.png" class="doc-img-frame" style="width:60%">
</div>
...
<div class="step-row-container">
  ...
  <div class="card-column">
    <div class="step-text" >
      <div class="card-body">
        <p>Enter a name for your security key device and click on <span style="font-weight:bold">Set up your Contactless Card</span>.
        </p>
      </div>
    </div>
  </div>
...
<div class="step-row-container">
  ...
  <div class="card-column">
    <div class="step-text" >
      <div class="card-body">
        <p>Touch your device (tap on your Contactless Card) to register your card.</span>
        </p>
      </div>
    </div>
  </div>
...
<div class="step-row-container">
  ...
  <div class="card-column">
    <div class="step-text" >
      <div class="card-body">
        <p>Click on <span style="font-weight:bold">Done</span> to receive your PIN via email.</span>
        </p>
      </div>
    </div>
  </div>
...
<p class="note-body" style="margin-bottom: 0"><span style="font-weight:bold;">Note:</span> When you register your Contactless Card, you will receive an email containing a 4 digit PIN which you need to use when you want to log in with your contactless card.</p><br></br>
...
<div class="step-row-container">
  ...
  <div class="card-column">
    <div class="step-text" >
      <div class="card-body">
        <p>Enter a name for your hardware security key and click on <span style="font-weight:bold"> Register</span>.
        </p>
      </div>
    </div>
  </div>
...
<div class="step-row-container">
  ...
  <div class="card-column">
    <div class="step-text" >
      <div class="card-body">
        <p>Touch your Hardware Security key.</p>
      </div>
    </div>
  </div>
</div>
